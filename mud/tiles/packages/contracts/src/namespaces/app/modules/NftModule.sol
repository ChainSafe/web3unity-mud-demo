...
import { MODULE_NAMESPACE, MODULE_NAMESPACE_ID, ERC721_REGISTRY_TABLE_ID } from "@latticexyz/world-modules/src/modules/erc721-puppet/constants.sol";
...
import { NftSystem } from "../systems/NftSystem.sol";
...
contract ERC721ModuleRegistrationLibrary {
  ...
  function register(IBaseWorld world, bytes14 namespace) public {
    ...
    world.registerSystem(_erc721SystemId(namespace), new NftSystem(), true);
  }
}
